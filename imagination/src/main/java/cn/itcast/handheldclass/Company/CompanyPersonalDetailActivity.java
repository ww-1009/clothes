...
import cn.itcast.handheldclass.Consumer.ConsumerSceneSelActivity;
import cn.itcast.handheldclass.R;
import cn.itcast.handheldclass.spinners.InformationFilling_spinner_sex;

public class CompanyPersonalDetailActivity extends BaseActivity {
    private Spinner  Spinner_sex;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_company_personal_detail);   initNavBar(true,"请完善信息",false);
        ...
        determine.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(CompanyPersonalDetailActivity.this , CompanySceneSelActivity.class);
                //启动
