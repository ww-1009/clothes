...
public class CompanySceneSelActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_company_scene_sel); initNavBar(true,"场景选择",false);
...
//                        Toast.LENGTH_LONG).show();
        ...
        scene_selection_check.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(CompanySceneSelActivity.this , CompanyClothesChangeActivity.class);
                //启动
