...
public class ChangePwdActivity extends BaseActivity {
    ...
    public void change_sure(View view) {
        ...
        if(old_pwd.equals("") || new_pwd1.equals("")|| new_pwd2.equals("")){
            ...
            Toast.makeText(ChangePwdActivity.this,"旧密码和新密码相同",Toast.LENGTH_SHORT).show();
            ...
            if(index == 0){
                ...
                String sql = "update company set pwd = '"+new_pwd1 + "' where username = '" + name + "'";
                db.execSQL(sql);
                Intent intent = new Intent(this,LoginActivity.class);
                startActivity(intent);
                Toast.makeText(ChangePwdActivity.this,"密码修改成功，请重新登录",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ChangePwdActivity.this,"原有密码输入错误",Toast.LENGTH_SHORT).show();
        }
    }
}