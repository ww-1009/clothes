...
public class DesignerClothesChangeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_designer_clothes_change);
        ...
        save.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Toast.makeText(DesignerClothesChangeActivity.this,"存档成功！",Toast.LENGTH_SHORT).show();
            }
