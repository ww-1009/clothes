...
public class DesignerSceneSelActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_designer_scene_sel);
...
//                        Toast.LENGTH_LONG).show();
        ...
        scene_selection_check.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(DesignerSceneSelActivity.this , DesignerClothesChangeActivity.class);
