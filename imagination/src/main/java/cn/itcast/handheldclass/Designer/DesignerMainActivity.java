...
public class DesignerMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chooseFromAlbum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(DesignerMainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(DesignerMainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, CHOOSE_PHOTO);
                } else {
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 动态申请权限
                if (ContextCompat.checkSelfPermission(DesignerMainActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(DesignerMainActivity.this, new String[]{Manifest.permission.CAMERA}, TAKE_PHOTO);
                } else {
                    // 启动相机程序
                    startCamera();
                }
        ...
        designer_search.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(DesignerMainActivity.this , DesignerCusAppointmentActivity.class);
                //启动
                startActivity(i);
            }
        });
        ...
        personal.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                //Intent是一种运行时绑定（run-time binding）机制，它能在程序运行过程中连接两个不同的组件。
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(DesignerMainActivity.this , DesignerOwnPageActivity.class);
                //启动
                startActivity(i);
            }
        });
