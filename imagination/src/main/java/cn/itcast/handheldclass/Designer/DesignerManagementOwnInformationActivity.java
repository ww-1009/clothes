...
import cn.itcast.handheldclass.Consumer.ConsumerManagementOwnInformationActivity;
import cn.itcast.handheldclass.DatabaseHelper;
import cn.itcast.handheldclass.MyData;
import cn.itcast.handheldclass.R;

public class DesignerManagementOwnInformationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_designer_management_own_information);
        ...
        bt_change.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(DesignerManagementOwnInformationActivity.this , ChangePwdActivity.class);
                //启动
                startActivity(i);
            }
        });
