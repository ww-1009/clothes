            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(ConsumerDesignerOwn4Activity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(ConsumerDesignerOwn4Activity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                case SDK_AUTH_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        Toast.makeText(ConsumerDesignerOwn4Activity.this, "授权成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 其他状态值则为授权失败
                        Toast.makeText(ConsumerDesignerOwn4Activity.this, "授权失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                default:
        ...
        yuyue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Runnable payRunnable = new Runnable() {
                    ...
                    @Override
                    public void run() {
                        PayTask alipay = new PayTask(ConsumerDesignerOwn4Activity.this);
