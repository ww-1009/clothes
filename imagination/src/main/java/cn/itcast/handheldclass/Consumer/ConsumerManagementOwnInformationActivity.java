...
public class ConsumerManagementOwnInformationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consumer_management_own_information);
        ...
        bt_change.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                //在存放资源代码的文件夹下下，
                Intent i = new Intent(ConsumerManagementOwnInformationActivity.this , ChangePwdActivity.class);
                //启动
                startActivity(i);
            }
        });
